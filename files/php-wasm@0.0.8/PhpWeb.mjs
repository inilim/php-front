...
//         tags.stdout = document.querySelector(
//             element.getAttribute("data-stdout"),
//         );
//     }

//     if (element.hasAttribute("data-stderr")) {
//         tags.stderr = document.querySelector(
//             element.getAttribute("data-stderr"),
//         );
//     }
...
//         getCode = fetch(element.getAttribute("src")).then((response) =>
//             response.text(),
//         );
//     }
...
//             getInput = fetch(tags.stdin.getAttribute("src")).then((response) =>
//                 response.text(),
//             );
//         }
//     }
